...
const dictionaries: Record<SupportedLocale, Dictionary> = {
  en: {
    ...
    'guide.reviveBody': 'If Gitagotchi is dead, spend 1000 earned EXP to revive it with stable health, energy, and mood.',
    'guide.close': 'Close',
    ...
    'notice.reviveNotEnough': 'Revive needs 1000 earned EXP. Available earned EXP: {exp}.',
    'notice.revived': 'Gitagotchi revived. Spent 1000 EXP.',
  ...
  ko: {
    ...
    'guide.reviveBody': 'Gitagotchi가 죽은 상태라면 누적 경험치 1000을 사용해 건강, 에너지, 기분이 안정된 상태로 부활시킬 수 있습니다.',
    'guide.close': '닫기',
    ...
    'notice.reviveNotEnough': '부활에는 누적 경험치 1000이 필요합니다. 사용 가능한 누적 경험치: {exp}.',
    'notice.revived': 'Gitagotchi가 부활했습니다. 경험치 1000을 사용했습니다.',
  ...
  ja: {
    ...
    'guide.reviveBody': 'Gitagotchi が死亡している場合、累計 EXP 1000 を使って健康、エネルギー、気分が安定した状態で復活できます。',
    'guide.close': '閉じる',
    ...
    'notice.reviveNotEnough': '復活には累計 EXP 1000 が必要です。使用可能な累計 EXP: {exp}。',
    'notice.revived': 'Gitagotchi が復活しました。EXP 1000 を使いました。',
  ...
  zh: {
    ...
    'guide.reviveBody': '如果 Gitagotchi 已死亡，可以消耗累计 EXP 1000，让它以稳定的健康、能量和心情复活。',
    'guide.close': '关闭',
    ...
    'notice.reviveNotEnough': '复活需要累计 EXP 1000。可用累计 EXP：{exp}。',
    'notice.revived': 'Gitagotchi 已复活。已消耗 EXP 1000。',
